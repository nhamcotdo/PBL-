...
// char ftpUsername[] = "nhamcotdo";
// char ftpPassword[] = "";
// String remoteFilePath = "/home/nhamcotdo/ftp";
// ESP32_FTPClient ftp(ftpServer, ftpUsername, ftpPassword, 5000, 2);
...
void loop() {
  ...
  } else if (!videoStarted && videoFile) {
    videoFile.close();
